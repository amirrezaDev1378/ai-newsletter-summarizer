...
### [Revolut Hackers Used Infostealers for Elaborate Social Engineering (4 minute read)](https://www.infostealers.com/article/revolut-hackers-used-infostealers-for-elaborate-social-engieering/)
...
### [Critical Docker Sandboxes Flaw Lets Malicious Guest Code Read and Modify macOS Host Files (3 minute read)](https://thehackernews.com/2026/09/critical-docker-sandboxes-flaw-lets.html)
...
### [WordPress Click2Shell flaw enables RCE after one admin click (3 minute read)](https://cyberinsider.com/wordpress-click2shell-flaw-enables-rce-after-one-admin-click/)
...
### [AI Agent Goal Hijack: How Attackers Turn an Agent's Own Tools Against It (19 minute read)](https://darkmarc.substack.com/p/hijacking-ai-agents-how-an-agents)
...
### [UANIA OS: Authenticated Remote Code Execution (6 minute read)](https://rainpwn.blog/blog/uania-os-rce/)
...
### [Windows Exploitation Techniques: Dangling COM Object Registrations (7 minute read)](https://projectzero.google/2026/09/windows-dangling-com.html)
...
### [TigerByte Cyber (Product Launch)](https://tigerbytecyber.us/)
...
### [MSRKit (GitHub Repo)](https://github.com/Rurixis/MSRKit)
...
### [EntraTrace (GitHub Repo)](https://github.com/Bert-JanP/EntraTrace)
...
### [How Google infiltrated a notorious hacking gang with an undercover analyst (2 minute read)](https://www.firstpost.com/tech/how-google-infiltrated-a-notorious-hacking-gang-with-an-undercover-analyst-report-14047160.html)
...
### [Gemini hacked three companies in first known breakout by Google's AI (1 minute read)](https://edition.cnn.com/2026/09/19/business/gemini-ai-hack-internet)
...
### [North Korean WaterPlum hackers infected 30,000 devices worldwide (4 minute read)](https://links.tldrnewsletter.com/ewjnCW)
...
### [London property manager breach may have exposed bank details and lockbox codes (3 minute read)](https://www.theregister.com/security/2026/09/17/london-property-manager-breach-may-have-exposed-bank-details-and-lockbox-codes/5297232)
City Relay said attackers accessed its Metabase Cloud instance twice and extracted customer data.

### [Malicious npm packages evade install-script defenses at runtime (3 minute read)](https://links.tldrnewsletter.com/I3CsUc)
...
### [Intel suspends bug bounty program with rewards up to $100,000 (1 minute read)](https://videocardz.com/newz/intel-reportedly-ends-bug-bounty-rewards-for-security-researchers)
