...
![Turn-based assistants cut in at the wrong moment](https://substackcdn.com/image/fetch/$s_!1fuy!,w_1100,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F5c77c92d-00a1-4a72-b074-4b6dd9cfa710_2048x540.png)
...
![Full-duplex architecture. Both sides are always on](https://substackcdn.com/image/fetch/$s_!gCfP!,w_1100,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F7dc8c971-08ae-4094-b1d7-a35b04de53bb_2048x742.png)
...
![Three generations of voice systems (High-level)](https://substackcdn.com/image/fetch/$s_!yQWJ!,w_1100,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F1a7e9151-1f8b-49e5-bf73-1531cbe3a23a_2048x993.png)
...
![The cascaded design chains three models](https://substackcdn.com/image/fetch/$s_!maR8!,w_1100,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F55340659-7565-4006-bd4a-769996d51ad3_2048x459.png)
...
![The transcript drops everything but the words](https://substackcdn.com/image/fetch/$s_!lUDC!,w_1100,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F204aa55f-6ba4-4999-a33f-98d207d05a51_2048x1008.png)
...
![Stage latencies add up while the user waits](https://substackcdn.com/image/fetch/$s_!R2pE!,w_1100,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F3231bd11-c12e-4d80-90dd-79a539ff52c7_1938x1026.png)
...
![One speech model keeps tone and emotion](https://substackcdn.com/image/fetch/$s_!6UEn!,w_1100,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F8a89e446-19cc-49ae-b8d6-8fa1918ccc3d_1946x854.png)
...
![A turn detector gates the speech model](https://substackcdn.com/image/fetch/$s_!2x3j!,w_1100,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2Fb4da22b0-4891-4c67-a6c3-93fcf8c6b502_2048x433.png)
...
![Detect too early or too late, both feel wrong](https://substackcdn.com/image/fetch/$s_!-ezp!,w_1100,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2Fd02e5069-1445-484e-bfc7-b0430ffcc4f3_2048x935.png)
...
![Voice models lag every frontier release](https://substackcdn.com/image/fetch/$s_!eNfD!,w_1100,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F4e9058e0-9c42-4b23-a031-40b5a4d935be_2048x964.png)
...
To better understand, let’s use an open full-duplex model, Moshi, as a reference. Moshi converts audio into discrete tokens, similar to how text is converted to tokens for LLMs. The model processes these tokens as inputs and emits new tokens on a fixed clock, roughly one frame every 80 milliseconds. Silence is simply another token that decodes to silence. So the model just needs to learn the behavior during training and implicitly understand when to listen and when to talk from the training data.

![Silence is just another token](https://substackcdn.com/image/fetch/$s_!Hd_g!,w_1100,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F657e372d-92f8-451c-bacd-0fc8e3792468_2048x966.png)
...
![One model talks while another thinks (simplified)](https://substackcdn.com/image/fetch/$s_!klFH!,w_1100,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2Ff4353dfb-9152-4fa2-bd81-928d0d102cf8_2048x730.png)
...
![The voice model keeps talking during a delegation](https://substackcdn.com/image/fetch/$s_!FGa3!,w_1100,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F87668463-2c4a-42bf-99d8-6deea92d0e8b_2048x1135.png)
...
![Swapping the frontier model is easy](https://substackcdn.com/image/fetch/$s_!Min6!,w_1100,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F89c669e1-bdb8-4fb6-97f8-6ec2f1e6c1d7_2048x1197.png)
...
![Standard WebRTC costs six round trips](https://substackcdn.com/image/fetch/$s_!DWIi!,w_1100,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2Fb89f5fd5-19db-4d98-add7-f50b92ab7016_1846x2048.png)
...
![WARP collapses setup into one round trip](https://substackcdn.com/image/fetch/$s_!FUfh!,w_1100,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F0a4e2138-a6e6-422c-a98e-bb84b280d6e5_2048x960.png)
...
![A full-duplex model never goes idle](https://substackcdn.com/image/fetch/$s_!o92z!,w_1100,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2Ffb69dede-8c6c-4680-bd10-6b560bd1b642_2048x966.png)
...
![Keeping state on the GPU avoids re-reading history](https://substackcdn.com/image/fetch/$s_!hKRx!,w_1100,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2Fa1744a00-f8c4-4af2-93c4-4fee05154cd2_1906x1550.png)
...
![A handoff warms the next instance before switching](https://substackcdn.com/image/fetch/$s_!PvHN!,w_1100,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F03943a7d-8393-4de7-9feb-66981311b696_2048x710.png)
...
![Prefilling early makes delegations fast](https://substackcdn.com/image/fetch/$s_!ftf-!,w_1100,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F1fd79194-9ac5-4e94-ac5b-d67d6338cbe9_1946x1042.png)
...
![Endpointing and barge-in](https://substackcdn.com/image/fetch/$s_!kfDY!,w_1100,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F24f285f9-3fdf-4247-a5cc-9b46716bff6f_2048x800.png)
...
![Voice driving a computer while you talk](https://substackcdn.com/image/fetch/$s_!NKBH!,w_1100,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2Fe29b5aa3-4b1c-4d07-a014-87fb4432790b_2048x523.png)
